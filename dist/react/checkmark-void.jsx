...
class Component extends React.Component {
    render() {
        return (
            <svg className={ [this.props.className, 'dibsvg-svg dibsvg-checkmark-void'].join(' ')} data-tn={'checkmark-void'}viewBox="0 0 250 250">
