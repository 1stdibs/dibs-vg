...
class Component extends React.Component {
    render() {
        return (
            <svg className={ [this.props.className, 'dibsvg-svg dibsvg-congratulations'].join(' ')} data-tn={'congratulations'}viewBox="0 0 250 250">
